      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <FormField
            ...
            type="text"
            register={register("nameEmployee")}
            error={errors.nameEmployee?.message}
          />
          ...
          <FormField
            ...
            placeholder="Data"
            type="date"
            register={register("datePayment")}
            error={errors.datePayment?.message}
          />

          <FormField
            label="Desconto INSS / FGTs"
            placeholder="Desconsto INSS / FGTs"
            type="number"
            register={register("discounts")}
            error={errors.overTime?.message}
          />

          <FormField
            label="Emprestimo em Cartão"
            placeholder="Emprestimo em Cartão"
            type="number"
            register={register("cardLoan")}
            error={errors.cardLoan?.message}
          />

          <FormField
            label="Dinheiro Antecipado"
            placeholder="Dinheiro Antecipado"
            type="number"
            register={register("advanceMoney")}
            error={errors.advanceMoney?.message}
          />

          <FormField
            label="Bonificação"
            placeholder="Bonificação"
            type="number"
            register={register("bonification")}
